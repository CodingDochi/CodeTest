...
public class Solution {
    public boolean solution(String[] phone_book) {
        ...
        phone_map.put(phone_book[0], true);
        ...
        for (int i = 1; i < phone_book.length; i++) {
            ...
            phone_map.put(phone_book[i], isPrefix);
            phone_map.remove(phone_book[i-1]);
        }

        answer = !phone_map.containsValue(true);
        return answer;
    }
